...
public class mistVillage
{
    private readonly DBRepository ___repo;

    public mistVillage(DBRepository __repo)
    {
        ___repo = __repo;
    }
    ...
    {
    List<Product> product =___repo.GetAllMistProducts();
    ...
    private void CartPrompt()
    {
        ...
        if(answer != null)
        {
            ...
            if(Char.ToUpper(answerC) == 'Y')
            {
                ...
                int number = ___repo.getMistProduct(item);
            ...
            tryagain:
                ...
                if (number>buy)
                {
                    ...
                    ___repo.UpdateMistInventory(item, remaining);
